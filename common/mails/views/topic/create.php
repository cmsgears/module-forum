...
<table cellspacing="0" cellpadding="0" border="0" margin="0" padding="0" width="80%" align="center" class="ctmax">
	...
	<tr>
		<td>
			<font face="Roboto, Arial, sans-serif">Your topic at <?= $siteName ?> is being created by site Administrator. The details are as mentioned below:</font>
		</td>
	</tr>
	<tr><td height="20"></td></tr>
	<tr>
		<td><font face="Roboto, Arial, sans-serif">Topic Name: <?= $name ?></font></td>
	</tr>
	<tr><td height="40"></td></tr>
</table>
